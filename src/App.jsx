        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center gap-8 md:gap-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2.5 text-gray-300 hover:text-cyan-300 transition-colors text-xs md:text-sm uppercase tracking-[0.2em] font-['Inter',system-ui,sans-serif]"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-gray-500 group-hover:text-emerald-400 transition-colors">
            ...
            <a
              ...
              className="group flex items-center gap-2.5 text-gray-300 hover:text-cyan-300 transition-colors text-xs md:text-sm uppercase tracking-[0.2em] font-['Inter',system-ui,sans-serif]"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-gray-500 group-hover:text-cyan-400 transition-colors">
            ...
            <a
              ...
              className="group flex items-center gap-2.5 text-gray-300 hover:text-cyan-300 transition-colors text-xs md:text-sm uppercase tracking-[0.2em] font-['Inter',system-ui,sans-serif]"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-gray-500 group-hover:text-cyan-400 transition-colors">
