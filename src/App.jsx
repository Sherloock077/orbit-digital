      ...
      <main className="relative z-10 w-full px-4 sm:px-6 md:px-8 pt-20 overflow-x-hidden">
        ...
        <section id="services" className="py-16 sm:py-20 px-2 sm:px-4 max-w-6xl mx-auto scroll-mt-32">
          ...
          >
            ...
            <div className="mt-6 sm:mt-8 w-32 sm:w-40 h-[1px] bg-gradient-to-r from-transparent via-cyan-500 to-transparent shadow-[0_0_10px_rgba(34,211,238,0.8)]" />
          </motion.div>
        ...
        <motion.section
          ...
          variants={sectionVariants}
          className="mb-24 sm:mb-32 md:mb-48 lg:mb-64 py-12 sm:py-16 md:py-24 relative"
        >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-[1fr,2fr] gap-8 sm:gap-10 md:gap-12 items-start px-2 sm:px-4">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-[#CCCCCC] leading-relaxed font-light text-left max-w-3xl">
        ...
        <section id="products" className="mb-24 sm:mb-32 md:mb-48 lg:mb-64">
          <motion.div
            initial="hidden"
            whileInView="visible"
