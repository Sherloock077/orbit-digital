...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-[#BBBBBB] font-mono selection:bg-cyan-500/30 overflow-x-hidden relative">
      ...
      <header className="fixed top-0 left-0 w-full z-[100] px-4 md:px-16 h-20 flex items-center justify-between border-b border-cyan-500/20 backdrop-blur-xl bg-black/60">
        <div className="flex-shrink-0 relative group">
          ...
          <img
            src={logoImg}
            alt="Orbit Digital"
            className="h-10 sm:h-12 md:h-16 w-auto object-contain cursor-pointer relative z-10 grayscale hover:grayscale-0 transition-all"
        ...
        <div className="flex items-center gap-4 md:gap-10">
          ...
          <button
            onClick={openModal}
            className="relative px-6 md:px-8 py-2 md:py-3 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] group"
          >
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 pt-20">
        <section className="py-20 sm:py-32 md:py-72 px-5 sm:px-10 text-center relative overflow-visible">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5, delay: 0.2 }}>
            ...
            <p className="text-lg md:text-2xl text-gray-400 max-w-sm md:max-w-2xl mx-auto font-light tracking-[0.2em] md:tracking-[0.4em] uppercase leading-relaxed border-t border-b border-white/10 py-5 md:py-6 bg-black/20 backdrop-blur-sm">
    // Технологии и автоматизация для бизнеса
              ...
              >
                {[
                  ...
                  >
                    ...
                    <p className="text-white text-base md:text-lg font-medium uppercase leading-snug tracking-tight">
                      {item.desc}
                    </p>
        ...
        <motion.section id="about" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={sectionVariants} className="mb-32 md:mb-64 py-16 md:py-24 relative">
          {/* Сетка фона — чуть увеличим прозрачность для четкости */}
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-[1fr,2fr] gap-10 md:gap-12 items-start">
            <div className="flex flex-col gap-4 border-l-2 border-purple-500 pl-6">
              <span className="text-purple-500 font-bold tracking-[0.5em] uppercase text-[10px] md:text-[12px]">Company.Log</span>
              <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight leading-none font-sans uppercase text-left">
                Разработка <br /> решений.
              </h2>
            </div>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="text-cyan-400 text-xs md:text-sm uppercase text-left font-mono tracking-widest">
        // Статус: Активен. Интеграция систем в процессе.
              </div>
            </div>
          </div>
        </motion.section>
        ...
        <div id="services" className="space-y-16 md:space-y-32 mb-32 md:mb-64">
          ...
          {/* БЛОК 1: Интеллектуальные системы */}
            ...
            <NeonFrame color="cyan">
              <div className="grid grid-cols-1 lg:grid-cols-[1.5fr,2fr] items-center gap-8 md:gap-16 p-6 md:p-12">
                <div className="relative overflow-hidden border border-cyan-500/30">
                  <img className="max-w-full h-auto hover:scale-105 transition-transform duration-300" src={aiImg} alt="AI Systems" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                </div>
                <div className="space-y-6 md:space-y-8 text-left">
                  <motion.img src={aiIconImg} alt="AI" className="w-16 h-16 md:w-20 md:h-20 filter saturate-50 group-hover:saturate-100 transition-all" animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 3 }} />
                  <div className="space-y-4">
                    <h3 className="text-3xl md:text-5xl font-black text-white tracking-tighter leading-none font-sans uppercase">Интеллектуальные <br /> системы</h3>
                    <p className="text-lg md:text-2xl text-gray-400 font-light leading-relaxed">Внедрение продвинутых алгоритмов машинного обучения и виртуальных помощников. Наши ИИ-решения берут на себя интеллектуальную нагрузку, гарантируя высокую производительность.</p>
                  </div>
                  <div className="text-sm md:text-lg text-cyan-600 group-hover:text-cyan-400 transition-colors font-mono">&gt; Load_AI_Service</div>
                </div>
              </div>
            </NeonFrame>
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={sectionVariants} className="group">
            <NeonFrame color="purple">
              <div className="grid grid-cols-1 lg:grid-cols-[2fr,1.5fr] items-center gap-8 md:gap-16 p-6 md:p-12">
                <div className="lg:order-1 space-y-6 md:space-y-8 text-left">
                  <motion.img src={dataIconImg} alt="Data" className="w-16 h-16 md:w-20 md:h-20 filter saturate-50 group-hover:saturate-100 transition-all" animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 3, delay: 0.5 }} />
                  <div className="space-y-4">
                    <h3 className="text-3xl md:text-5xl font-black text-white tracking-tighter leading-none font-sans uppercase">Работа <br /> с данными</h3>
                    <p className="text-lg md:text-2xl text-gray-400 font-light leading-relaxed">Разработка серверной логики и аналитических движков для работы с Big Data. Мы строим системы, где каждый байт информации работает на достижение ваших стратегических целей.</p>
                  </div>
                  <div className="text-sm md:text-lg text-purple-600 group-hover:text-purple-400 transition-colors font-mono">&gt; Data_Process_Run</div>
                </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={sectionVariants} className="group">
            <NeonFrame color="blue">
              <div className="grid grid-cols-1 lg:grid-cols-[1.5fr,2fr] items-center gap-8 md:gap-16 p-6 md:p-12">
                ...
                <div className="space-y-6 md:space-y-8 text-left">
                  <motion.img src={autoIconImg} alt="Auto" className="w-16 h-16 md:w-20 md:h-20 filter saturate-50 group-hover:saturate-100 transition-all" animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 3, delay: 1 }} />
                  <div className="space-y-4">
                    <h3 className="text-3xl md:text-5xl font-black text-white tracking-tighter leading-none font-sans uppercase">Инженерная <br /> оптимизация</h3>
                    <p className="text-lg md:text-2xl text-gray-400 font-light leading-relaxed">Разработка и внедрение прикладного ПО для синхронизации сложных бизнес-операций. Обеспечиваем бесперебойную работу цифровых сервисов без необходимости внешнего контроля.</p>
                  </div>
                  <div className="text-sm md:text-lg text-blue-600 group-hover:text-blue-400 transition-colors font-mono">&gt; Start_Automation</div>
                </div>
              </div>
            </NeonFrame>
          </motion.div>
